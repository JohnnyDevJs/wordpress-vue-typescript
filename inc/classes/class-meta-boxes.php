...
class Meta_Boxes {
    ...
    public function add_custom_meta_box() {
        ...
        $screens = [
            'unique_ID' => ['shortable-gallery-page-options', 'shortable-page-gallery-page-options'],
            'callback'  => ['custom_shortable_gallery_meta_box_html', 'custom_shortable_gallery_meta_box_html'],
            'post_type' => ['portfolio', 'page'],
            'box_title' => ['Galeria', 'Galeria']
        ];
    ...
    public function custom_shortable_gallery_meta_box_html( $post ) {
         ...
         * 'shortable_gallery_meta_box_nonce' and unique nonce input value.
         */
        wp_nonce_field( plugin_basename( __FILE__ ), 'shortable_gallery_meta_box_nonce' );
    ...
    public function save_post_meta_data( $post_id ) {
        ...
        if ( !  isset( $_POST['shortable_gallery_meta_box_nonce'] ) ||
            !  wp_verify_nonce( $_POST['shortable_gallery_meta_box_nonce'], plugin_basename( __FILE__ ) )
        ) {
            return;
        }
